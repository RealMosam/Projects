    ...
    <div class="modal-dialog modal-sm" id="cform">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title text-center form-title" style="color:white;">Course Add</h4>            <button type="button" class="close" data-dismiss="modal" ><a href='http://localhost/E-Learning-Minor-Project/courses.php' style='font-size: 30px;color:black;float:right;'>&times;</a></button>
        </div>
...
<!--                  password-->
                ...
                <div class="row">
                  ...
                  <div class="col-xs-12">
                    <button type="submit" class="btn btn-green btn-block btn-flat"  >Add this course!</button>
                  </div>
                </div>
              </form>
            </div>
 ...
 <p><button type="submit" id="javascript"  onClick='showMessage(this.id)'>Add the course</button></p>
</div>
 ...
 <p><button type="submit" id="reactjs"  onClick='showMessage(this.id)'>Add the course</button></p>
</div>
  ...
  <p><button type="submit" id="android"  onClick='showMessage(this.id)'>Add the course</button></p>
</div>
       <div class="card" >
 ...
 <p><button type="submit" id="java"  onClick='showMessage(this.id)'>Add the course</button></p>
</div>
    <br><br>
<!--    row2-->
        <div class="card" >
 ...
 <p><button type="submit" id="angularjs"  onClick='showMessage(this.id)'>Add the course</button></p>
</div>
     <div class="card" >
 ...
 <p><button type="submit" id="c++"  onClick='showMessage(this.id)'>Add the course</button></p>
</div>
       <div class="card" >
 ...
 <p><button type="submit" id="jade"  onClick='showMessage(this.id)'>Add the course</button></p>
</div>
       <div class="card" >
  ...
  <div style="margin: 24px 0;">
    ...
    <a href="#"><i class="fa fa-facebook"></i></a> 
       ...
       <p><button type="submit" id="bootstrap"  onClick='showMessage(this.id)'>Add the course</button></p>
 </div>
...
<!--row3-->
 ...
 <p><button type="submit" id="php"  onClick='showMessage(this.id)'>Add the course</button></p>
</div>
 ...
 <p><button type="submit" id="web-ui"  onClick='showMessage(this.id)'>Add the course</button></p>
</div>
       <div class="card" id="coursecard">
  ...
  <p><button type="submit" id="Nodejs"  onClick='showMessage(this.id)'>Add the course</button></p>
</div>
       <div class="card" >
 ...
 <p><button type="submit" id="vue-js"  onClick='showMessage(this.id)'>Add the course</button></p>
</div>
    <br><br>
...
<!--    row4-->
 ...
 <p><button type="submit" id="maven"  onClick='showMessage(this.id)'>Add the course</button></p>
</div>
 ...
 <p><button type="submit" id="perl"  onClick='showMessage(this.id)'>Add the course</button></p>
</div>
       <div class="card" id="coursecard">
  ...
  <p><button type="submit" id="chart-js"  onClick='showMessage(this.id)'>Add the course</button></p>
</div>
       <div class="card" >
 ...
 <p><button type="submit" id="mongodb"  onClick='showMessage(this.id)'>Add the course</button></p>
</div>
    <br><br>
    </div>
