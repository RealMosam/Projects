...
echo "<tr >";
echo "<td>Sr</td><td>Username</td><td>Password</td></td><td>Course Name</td><td>Time</td>"; 
echo "</td>";
echo "</tr>";
echo "</table><hr>";
...
echo  "<td >".$i."</td>"."<td>".$row["fname"]."</td><td>".$row["password"]."</td><td>".$row["coursename"]."</td><td>".$row['time']."</td>";
