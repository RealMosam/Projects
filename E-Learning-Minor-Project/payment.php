...
$result=mysqli_query($conn,"select * from exptable where fname='$fname' and password='$password'")
   ...
   if($row['fname']==$fname and $row['password']==$password)//for success
    {
        $_SESSION["username"]=$fname;
        $paymenttime= date("m/d/y G.i:s<br>", time());
        $sql = "insert into paymenttable values('$fname','$password','$coursename','$paymenttime')";
